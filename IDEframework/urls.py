...
urlpatterns = [
    ...
    path('register/IDE/', IDE_views.index),
    path('login/IDE/lesson/', lesson_views.index),
    path('register/IDE/lesson/self-learn/', self_learn_views.index),
    ...
    path('register/IDE/lesson/group-<str:group_id>/', group_id_views.index),
    path('login/IDE/lesson/group-<str:group_id>/group-learn', group_learn_views.index),
    path('register/IDE/lesson/group-<str:group_id>/group-learn', group_learn_views.index),
